...
def _hwbp_veh_bypass_cs(cls_name: str, method_name: str, *, public: bool) -> str:
    ...
    return (
        ...
        "                }}\n"
        "            }}\n\n"
        "            // CLR nLoadImage unhook disabled — needs further debugging.\n"
        "            // HWBP+VEH alone bypasses AMSI. The nLoadImage hook is a\n"
        "            // separate Defender layer that requires additional work.\n"
        "        }}\n"
        "        catch {{ }}\n"
        "    }}\n\n"
